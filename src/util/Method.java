...
public class Method {
    ...
    public static boolean sendMail(String to, String subject, String text, String file) {
    ...
    public List<String> downloadEmails(String protocol, String host, String port,
