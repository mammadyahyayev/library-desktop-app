...
public class EditStudent extends javax.swing.JFrame {
    ...
    EditStudent(DaoImpl dao, Long selectedRow) {
        try {
            initComponents();
            this.dao = dao;
    ...
    private void editBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editBtnMouseClicked
        try {
            ...
            if (nameTxt.getText().isEmpty() || surnameTxt.getText().isEmpty() || emailTxt.getText().isEmpty() || groupTxt.getText().isEmpty()) {
                ...
                boolean isUpdated = dao.updateStudent(student, selectedRow);
                if (fileName != null) {
                    boolean isUpdateImg = dao.updateStudentImg(selectedRow, fileName);
                }
                if (isUpdated) {
