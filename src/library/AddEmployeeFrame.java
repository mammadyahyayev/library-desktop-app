    ...
    private void saveBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveBtnMouseClicked
        if (nameTxt.getText().isEmpty() || surnameTxt.getText().isEmpty() || addressTxt.getText().isEmpty()
            ...
            try {
                ...
                boolean isAdded = dao.add(employee, fileName);
                if (isAdded) {
                    JOptionPane.showMessageDialog(null, "İşçi Əlavə Olundu...");
                    this.setVisible(false);
                } else {
                    JOptionPane.showMessageDialog(null, "İşçi Əlavə Olunmadı...");
