...
public class AddAuthor extends javax.swing.JFrame {
    ...
    private void addImageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addImageActionPerformed
        try {
            ...
            photo.setIcon(icon);
            File fBlob = new File(filenamePath);
    ...
    private void saveBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveBtnMouseClicked
        ...
        if (nameTxt.getText().isEmpty() || surnameTxt.getText().isEmpty()) {
            ...
            try {
                ...
                boolean isAdded = dao.add(author, filename);
                if (isAdded) {
                    JOptionPane.showMessageDialog(null, "Müəllif Əlavə Olundu...");
                    this.setVisible(false);
                } else {
                    JOptionPane.showMessageDialog(null, "Müəllif Əlavə Olunmadı!!!");
                }
            } catch (Exception ex) {
