...
public class ViewTableOrder extends javax.swing.JFrame {
    ...
    ViewTableOrder(DaoImpl dao, Long selectedRow) {
        try {
            initComponents();
            this.dao = dao;
            ...
            Logger.getLogger(ViewTableOrder.class.getName()).log(Level.SEVERE, null, ex);
        }
